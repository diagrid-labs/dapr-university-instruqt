...
---
In this challenge you'll inspect the PrDigest application and review the AppHost configuration, MAF agent configuration, workflow code and one activity. It will take about 8 minutes to complete.
