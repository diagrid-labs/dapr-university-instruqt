...
---
In this challenge you'll start the application and deliberately crash the workflow mid-run, restart it, and prove that completed agent (LLM) calls are replayed from durable state — not re-run. It will take about 8 minutes to complete.
