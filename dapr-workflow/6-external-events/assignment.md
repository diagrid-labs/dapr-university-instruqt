In this challenge, you'll explore a workflow application that demonstrates the external system interaction pattern. This hands-on challenge takes about 5 minutes to complete.
